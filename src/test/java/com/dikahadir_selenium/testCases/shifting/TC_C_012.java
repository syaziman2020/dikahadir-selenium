...
public class TC_C_012 extends BaseClass {
	@Test(description = "TC_C_012")
	void successNameAndCodeEdit() throws InterruptedException {
		...
		sp.clickSearch();
		Thread.sleep(500);
		Assert.assertEquals(sp.datasFirstColumn().getFirst().getText(),newName);
	}
